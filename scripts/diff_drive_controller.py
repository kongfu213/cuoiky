...
class RobotController:
    def __init__(self):
        ...
        self.pub_tt = rospy.Publisher('/xe/tt_velocity_controller/command', Float64, queue_size=10)
        self.pub_tp = rospy.Publisher('/xe/tp_velocity_controller/command', Float64, queue_size=10)
        self.pub_sp = rospy.Publisher('/xe/sp_velocity_controller/command', Float64, queue_size=10)
        self.pub_st = rospy.Publisher('/xe/st_velocity_controller/command', Float64, queue_size=10)
